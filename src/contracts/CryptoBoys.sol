...
// Freenet smart contract inherits ERC721 interface
contract Freenet is ERC721 {
  ...
  mapping(uint256 => CryptoBoy) public allFreenet;
  ...
  function mintCryptoBoy(string memory _name, string memory _tokenURI, uint256 _price, string[] calldata _colors) external {
    ...
    allFreenet[cryptoBoyCounter] = newCryptoBoy;
  }
  ...
  function buyToken(uint256 _tokenId) public payable {
    ...
    CryptoBoy memory cryptoboy = allFreenet[_tokenId];
